...
# 1. 读取数据（保持不变）
# ------------------------------
read_file = r"C:\Users\Terry\Desktop\ABC\立项\2026-交通+教学\2026-统计建模大赛\数据集\原始数据集\ETTm2.csv"
results_df_path = r"C:\Users\Terry\Desktop\ABC\立项\2026-交通+教学\2026-统计建模大赛\数据集\原始数据集\ETTm2.csv"
...
# 4. 特征列与目标变量
# ------------------------------
original_features = ['HUFL', 'HULL', 'MULL','MUFL', 'LUFL', 'LULL']
